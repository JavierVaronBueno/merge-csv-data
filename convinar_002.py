...
def merge_csv_files(directory, pattern):
    ...
    """
    logging.info(f"Iniciando proceso de combinación de archivos CSV para patrón '{pattern}' en {directory}")
...
def process_all_patterns(directory, patterns):
    """
    ...
    for pattern in patterns:
        ...
        if merge_csv_files(directory, pattern):
...
if __name__ == "__main__":
    ...
    patterns = [
        "USD_THB Historical Data",
        "SAR_USD Historical Data",
        "IDR_USD Historical Data",
        "USD_RUB Historical Data",
        "KRW_USD Historical Data",
        "USD_SDG Historical Data",
        "CNY_USD Historical Data",
        "AUD_USD Historical Data",
        "JPY_USD Historical Data",
        "Datos históricos USD_INR"
    ]
    
    try:
        process_all_patterns(directory, patterns)
